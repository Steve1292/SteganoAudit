...
if($count == 1) {
        $output = shell_exec("python encode_password.py $imagePath $password $yourUsername");
        echo $output;
...
function sendemail($imgPath)
{
    ...
    $email = "stevetauro05@gmail.com";
    $password = "hochlxpklkozznyl";

    $to = "smrufacc420@gmail.com";
    $subject = "Recover your password by image steganography";
    $message = "Below is the attached encoded image which has your password. Decode it using SteganoAudit forgot password page.";
    $headers = "From: $email";
